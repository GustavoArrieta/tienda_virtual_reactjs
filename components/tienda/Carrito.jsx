...
class Carrito extends React.Component{
  ...
  mostrarCarrito(){
    return this.state.listaCarrito.map(
      (producto) => { return <CarritoDetalle key={ producto.id } id={producto.id}  descripcion={ producto.descripcion } imagen={ producto.imagen }  cantidad={ producto.cantidad } precio ={producto.precio} actualizarDisponible={this.actualizarDisponible.bind(this)}/> }
    )
  }
  //==============================================================================
  ...
  pagarCarrito(){
    ...
    request
    .get('https://tienda-a4e29.firebaseio.com/')            //Realizar una consulta a la base de datos
    .then((res) => {
...
actualizarDB(itemCatalogo, cantidad){
  request.put(`https://tienda-a4e29.firebaseio.com/${itemCatalogo.id}.json`)  //Realizar consulta a base de datos
